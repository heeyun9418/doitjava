...
public class CoffeeShop {
	public static void main(String[] args) {
		...
		String menu = "";
		System.out.println("A: 아메리카노, M: 카페모카, C: 캐러멜마끼아또, T: 오늘의 커피");
		System.out.print("> ");
		menu = scan.next();
		menu = menu.toUpperCase();
		System.out.println(menu);	//문자를 대문자로 변경해준다.
		//toLowerCase() 문자를 소문자로 변경해준다.
		...
		switch(menu) {
			...
			case "M": case "m" :
				...
				break;
			case "C": case "c" :
				System.out.println("캐러멜마끼아또를 주문하셨습니다.");
				break;
			case "T": case "t" :
