...
public class VariableEx {
	public static void main(String[] args) {
		...
		int soondae = 3000;	//순대 3000원
		int umuk = 500;		//어묵 500원
		int kimbab = 2000;	//김밥 2000원
		
		int order1 = 0, order2 = 0, order3 = 0, order4 = 0;
		/*
		 * 변수를 선언 후 초기값을 넣어주는 것이 좋다.
		 * 변수의 초기값은 숫자는 0, 불리언 false, 문자열은"", char형은 0으로 초기화한다.
		 */
		order1 = 2;
		order2 = 1;
		order3 = 6;
		...
		int res2 = soondae * order2;
		int res3 = umuk * order3;
		...
		System.out.println("어묵은 " + order3 + "개 주문하여서 금액은 " + res3 + "원입니다.");
